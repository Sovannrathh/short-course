      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            ...
            <div class="mt-2">
              <input type="phonenum" name="phonenum" id="phonenum" autocomplete="current-phonenum" required
                class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
            </div>

            <div>
              <label for="email" class="mt-10 block text-sm/6 font-medium text-gray-900">Email address</label>
              <div class="mt-2">
            ...
            <div>
              <label for="payment" class="mt-10 block text-sm/6 font-medium text-gray-900">Payment</label>
            ...
            <div>
              <button type="submit"
                class="mt-10 flex w-full justify-center rounded-md bg-yellow-500 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-yellow-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Pay</button>
            </div>
...
<?php /**PATH /Users/chhimsonita/Desktop/year3/term2/capstone/testing_laravel/resources/views/payment.blade.php ENDPATH**/ ?>